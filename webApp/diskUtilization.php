    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
						<h2> Chart showing Disk I/O of all the instances</h2>

						<?php
						$iFrameUrl = "http://52.24.4.178:5601/#/dashboard/Disk-I-slash-O-username?embed&_g=()&_a=(filters:!(),panels:!((col:1,id:instance1-MaxDiskRead,row:1,size_x:6,size_y:3,type:visualization),(col:7,id:instance1-MaxDiskWrite,row:1,size_x:5,size_y:3,type:visualization),(col:1,id:instance2-MaxDiskRead,row:4,size_x:6,size_y:3,type:visualization),(col:7,id:instance2-MaxDiskWrite,row:4,size_x:5,size_y:3,type:visualization)),query:(query_string:(analyze_wildcard:!t,query:'*')),title:'Disk%20I%2FO%20-%20username')";
