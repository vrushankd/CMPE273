    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
						<h2> Chart for CPU Utilization of all instances</h2><br />
						<?php
						$iFrameUrl = "http://52.24.4.178:5601/#/dashboard/CPU-Utilization-username?embed&_g=()&_a=(filters:!(),panels:!((col:3,id:instance1-MaxCPU,row:1,size_x:6,size_y:3,type:visualization),(col:3,id:instance2-MaxCPU,row:4,size_x:6,size_y:3,type:visualization)),query:(query_string:(analyze_wildcard:!t,query:'*')),title:'CPU%20Utilization%20-%20username')";
